...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   GameTile: () => (/* binding */ GameTile)\n/* harmony export */ });\n/* harmony import */ var _components_GameTile_GameTile_template_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @/components/GameTile/GameTile.template.html */ \"./src/components/GameTile/GameTile.template.html\");\n/* harmony import */ var _components_GameTile_GameTile_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/components/GameTile/GameTile.css */ \"./src/components/GameTile/GameTile.css\");\n/* harmony import */ var _assets_icons_bomb_svg__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../assets/icons/bomb.svg */ \"./assets/icons/bomb.svg\");\n/* harmony import */ var _assets_icons_bomb_svg__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_assets_icons_bomb_svg__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var _utils_load_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @/utils/load-css */ \"./src/utils/load-css.ts\");\n/* harmony import */ var _utils_get_from_shadow_by_id__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @/utils/get-from-shadow-by-id */ \"./src/utils/get-from-shadow-by-id.ts\");\n/* harmony import */ var _lib_boolean__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @/lib/boolean */ \"./src/lib/boolean.ts\");\n\n\n\n\n\n\nclass GameTile extends HTMLElement {\n    constructor() {\n        super();\n        this.mineCount = 0;\n        this.row = 0;\n        this.col = 0;\n        this.hasFlag = false;\n        this.isMine = false;\n        this.isRevealed = false;\n        this.attachShadow({ mode: 'open' });\n    }\n    static get observedAttributes() {\n        return ['tile-mine-count', 'tile-row', 'tile-col', 'tile-has-flag', 'tile-is-mine', 'tile-is-revealed'];\n    }\n    attributeChangedCallback(prop, _, value) {\n        const changedAttribute = prop.replace('tile-', '');\n        switch (changedAttribute) {\n            case 'mine-count':\n                this.mineCount = Number(value);\n            case 'row':\n                this.mineCount = Number(value);\n            case 'col':\n                this.mineCount = Number(value);\n            case 'has-flag':\n                this.hasFlag = (0,_lib_boolean__WEBPACK_IMPORTED_MODULE_5__.isTrue)(value);\n            case 'is-mine':\n                this.isMine = (0,_lib_boolean__WEBPACK_IMPORTED_MODULE_5__.isTrue)(value);\n            case 'is-revealed':\n                this.isRevealed = (0,_lib_boolean__WEBPACK_IMPORTED_MODULE_5__.isTrue)(value);\n        }\n        this.render();\n    }\n    connectedCallback() {\n        this.render();\n    }\n    render() {\n        if (this.shadowRoot)\n            this.shadowRoot.innerHTML = _components_GameTile_GameTile_template_html__WEBPACK_IMPORTED_MODULE_0__[\"default\"];\n        (0,_utils_load_css__WEBPACK_IMPORTED_MODULE_3__.loadCSS)(this, _components_GameTile_GameTile_css__WEBPACK_IMPORTED_MODULE_1__[\"default\"]);\n        if (this.isMine) {\n            const tile = (0,_utils_get_from_shadow_by_id__WEBPACK_IMPORTED_MODULE_4__.getFromShadowById)(this, 'game-tile');\n            tile.innerHTML = (_assets_icons_bomb_svg__WEBPACK_IMPORTED_MODULE_2___default());\n        }\n    }\n}\ncustomElements.define('app-game-tile', GameTile);\n\n\n//# sourceURL=webpack://minesweeper/./src/components/GameTile/GameTile.ts?");
